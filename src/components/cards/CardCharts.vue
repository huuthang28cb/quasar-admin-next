<template>
    <div class="row q-col-gutter-sm  q-py-sm">
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
            <q-card class="q-ma-xs item_card_custom">
                <q-card-section class="text-h6 text-dark text-dark-mode">
                    Today's View
                </q-card-section>
        ...
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
            <q-card class="q-ma-xs item_card_custom">
                <q-card-section class="text-h6 text-black text-dark-mode">
                    Daily Sales
                </q-card-section>
                <q-card-section class="q-pa-none">
                        ...
                        "itemStyle": {
                            "normal": {
                                "color": new echarts.graphic.LinearGradient(
                                    0, 0, 0, 1, [
                                        { offset: 0, color: '#ef566a' },
                                        { offset: 1, color: '#627af7' }
                                    ]
                                )
                            }
                        }
